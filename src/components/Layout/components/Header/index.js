...
import { faCircleXmark, faSpinner, faMagnifyingGlass, faPlus, faSignIn, faEllipsisVertical,faEarthAsia, faQuestion, faKeyboard } from '@fortawesome/free-solid-svg-icons';
